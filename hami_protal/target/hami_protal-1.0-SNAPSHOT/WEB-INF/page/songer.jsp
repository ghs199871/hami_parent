            ...
            <div id="glory-body" class="clearfix">
                <div id="glory-content">
                    <div class="clearfix" id="artist_block" data-spm="350708677">
                        <div id="artist_info">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td valign="top"><a href="http://emumo.xiami.com/genre/detail/sid/1541">
                        ...
                        <div id="artist_photo">
                            <a id="cover_lightbox"
                               href="http://pic.xiami.net/images/artistlogo/73/15554092003073.jpg" target="_blank"
                    ...
                    <div class="sec_Rlt mgt30" id="artist_trends" data-spm="350708705">
                        ...
                        <div id="content">
                            <table cellspacing="0" cellpadding="0" class="track_list" summary="${songer.srname}的热门歌曲">
                                <tbody>
                                <c:forEach items="${songer.songs}" var="s" varStatus="v">
                                    <c:if test="${s.sid!=null}">
                                        <tr data-needpay="1" data-playstatus="1" data-downloadstatus="2"
                                            ...
                                            <td class="trackid">${v.count}</td>
                                            <td class="song_name">
                                                <a href="#" title="">${s.sname}</a>
                                            ...
                                            <td class="song_act">
                                                <div class="song_do" style="width:170px;_width:180px;">
                                                    <a class="song_play" href="#" title="试听"
                                                       onclick="play(${s.sid});"><span>试听</span></a>
