...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#updSong[update]").click(function () {
                var sid = $(this).val();
                window.location.href = "/song/toUpdate?sid=" + parseInt(sid);
            })

            $("#delSong[del]").click(function () {
                var sid = parseInt($(this).attr("value"));
                layer.confirm('确定删除该歌曲吗？', {icon: 3, title: '提示'}, function (index) {
                    $.ajax({
                        url: "/song/delSong",
                        data: {sid: sid},
                        type: "post",
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：想你的365天" name="sname"
                                                       value="${mq.sname}" id="sname" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：李玟" name="srname" value="${mq.srname}"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：宝莲灯" name="aname" value="${mq.aname}"
                                            ...
                                            <select id="tid" name="tid" class="form-control ">
                                                ...
                                                <c:forEach items="${mtypes}" var="mtype">
                                                    <option value="${mtype.tid}"
                                                            <c:if test="${mtype.tid == mq.tid}">selected</c:if>>${mtype.tname}</option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <table class="table table-striped table-images"
                                        ...
                                        <c:forEach items="${page.list}" var="song">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" id="updSong" update
                                                            value="${song.sid}"> 修改
                                                    </button>
                                                    <button data-toggle="button" class="btn btn-sm btn-warning"
                                                            value="${song.sid}" id="delSong" del> 删除
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
