...
<form data-validate="parsley" method="post" novalidate="" action="/songer/addSonger"
      class="form-horizontal label-left" id="songer-form"/>
<div class="wrapper">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label for="tname" class="control-label">流派<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                    ...
                                    <div class="control-group">
                                        <label for="isHot" class="control-label">是否热门<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                    ...
                                    <div class="control-group">
                                                    ...
                                                    <div class="image-set">
                                                        <a class="example-image-link"
                                                           ...
                                                           title="Click on the right side of the image to move forward.">
                                                            <img class="example-image" id="songerImg"
                                                                 src="../../img/gallery-photo/thumb-3.jpg"
                                                                 alt="Plants: image 1 0f 4 thumb" width="150"
                                                                 height="150"/>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="examples" class="section examples-section">
                                            ...
                                            <input type="hidden" name="lastImg" id="lastImg">
                                ...
                                <div class="form-actions text-right">
                                    <button class="btn btn-primary" type="submit">提交艺人</button>
                                </div>
                            </div>
                        </div>
                    </div>
