                ...
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <form data-validate="parsley" method="post" novalidate="" action="/song/addSong"
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                                <select id="songer" name="srid" class="form-control ">
                                                    <option value="">--请选择--</option>
                                                    <c:forEach items="${songers}" var="s">
                                                        <option value="${s.srid   }">${s.srname}</option>
                                                    </c:forEach>
                                                </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                                <select id="album" name="aid" class="form-control ">
                                                    <option value="">--请选择--</option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                                <select id="mtype" name="tid" class="form-control ">
                                                    <option value="">--请选择--</option>
                                                    <c:forEach items="${mtypes}" var="m">
                                                        <option value="${m.tid}">${m.tname}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input type="file" name="picfileMp3" id='i1-file' accept=".mp3, .wma"
                                               onchange="submitFileMp3();" style="display: none">
