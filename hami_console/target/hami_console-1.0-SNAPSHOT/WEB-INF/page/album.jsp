...
<head>
    ...
    <script>
            ...
            $(".btn-primary[modify]").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (t) {
                        $("#aid").val(t.aid);
                        $("#uname").val(t.aname);
                        $("#ucompany").val(t.company);
                        $("#uPdate").val(t.pdate);
                        $("#ualbumImg").attr("src", "${filePath}" + t.pic);
                        $("#ulang").val(t.lang);
                    }
                });
                pop1 = layer.open({
        ...
        function updsubmitFile() {
            $("#ulocation").val($("#ui-file").val());
                                ...
                                <fieldset id="find">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" value="${mq.aname}" placeholder="如：thriller"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" value="${mq.company}" placeholder="如：史诗唱片"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                    class="icon-user"></i></span>
                                                <input type="text" value="${mq.lang}" placeholder="如：英语" name="lang"
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input readonly id="searchPdate"
                                                       value="<fm:formatDate value='${mq.pdate}' pattern='yyyy-MM-dd'></fm:formatDate>"
                                    ...
                                    <table class="table table-striped table-images"
                                        ...
                                        <c:forEach items="${page.list}" var="album" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="hidden-xs"><p><strong><fm:formatDate value="${album.pdate}"
                                                                                                pattern="yyyy-MM-dd"></fm:formatDate></strong>
                                                </p></td>
                                                <td class="hidden-xs">${album.lang}</td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" modify tid="${album.aid}"> 修改
                                                    </button>
                                                    <button data-toggle="button" class="btn btn-sm btn-warning"
                                                            tid="${album.aid}" tpath="${filePath}${album.pic}"> 删除
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
...
<div id="albumPop" style="margin-right: 50px;margin-top: 50px; display: none">
    <form id="addAlbumForm" class="layui-form" method="post" action="/album/addAlbum" enctype="multipart/form-data"
          lay-filter="example">
        <div class="layui-form-item">
            <label class="layui-form-label" style="width:100px">专辑名字</label>
            <div class="layui-input-block">
                <input type="text" name="aname" style="color: black; border-color: lightgray;background-color: white"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="company" style="color: black; border-color: lightgray;background-color: white"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="addPdate" name="pdate"
                        ...
                        <div class="image-set">
                            <a class="example-image-link" href="../../img/gallery-photo/image-3.jpg"
                               ...
                               title="Click on the right side of the image to move forward.">
                                <img id="albumImg" class="example-image" src="../../img/gallery-photo/thumb-3.jpg"
        ...
        <div class="layui-form-item">
            ...
            <div id="examples" class="section examples-section">
                <div class="col-sm-6">
                    <div class="input-group">
                        ...
                        <label class="input-group-btn">
                            <input type="button" id="i-check" value="选择封面" class="btn btn-primary"
                ...
                <input type="file" name="picfile" id='i-file' accept=".jpg, .png" onchange="submitFile()"
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button id="upd" class="layui-btn layui-btn-normal layui-btn-radius" lay-submit="" lay-filter="demo1">
                    添加专辑
                </button>
            </div>
        </div>
...
<div id="updalbumPop" style="margin-right: 50px;margin-top: 50px; display: none">
    <form id="updateAlbumForm" class="layui-form" method="post" action="/album/updAlbum" enctype="multipart/form-data"
          lay-filter="example">
        <input type="hidden" name="aid" id="aid">
        <div class="layui-form-item">
            <label class="layui-form-label" style="width:100px">专辑名字</label>
            <div class="layui-input-block">
                <input id="uname" type="text" name="aname"
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" style="width:100px">发行公司</label>
            <div class="layui-input-block">
                <input id="ucompany" type="text" name="company"
                       style="color: black; border-color: lightgray;background-color: white"
                       lay-verify="company" autocomplete="off" placeholder="请输入公司名" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" style="width:100px">发行时间</label>
            <div class="layui-input-block">
                <input type="text" id="uPdate" name="pdate"
                       style="color: black; border-color: lightgray;background-color: white" lay-verify="pdate"
                       autocomplete="off" placeholder="请输入发行时间" class="layui-input">
            </div>
        </div>
                    ...
                    <div class="image-row">
                        <div class="image-set">
                            <a class="example-image-link" href="../../img/gallery-photo/image-3.jpg"
                               data-lightbox="example-set"
                               title="Click on the right side of the image to move forward.">
                                <img id="ualbumImg" class="example-image"
                                     src="../../img/gallery-photo/thumb-3.jpg"
                                     alt="Plants: image 1 0f 4 thumb" width="150" height="150"/>
                            </a>
                        </div>
                    </div>
        ...
        <div class="layui-form-item">
            <label for="i-file" class="layui-form-label" style="width:100px">选择文件</label>
            <!--<div class="col-sm-4 control-label">选择文件</div>-->
            <div id="updexamples" class="section examples-section">
                <div class="col-sm-6">
                    <div class="input-group">
                        <input id='ulocation' class="form-control" onclick="$('#ui-file').click();">
                        <label class="input-group-btn">
                            <input type="button" id="ui-check" value="选择封面" class="btn btn-primary"
                                   onclick="$('#ui-file').click();">
                        </label>
                    </div>
                </div>
                <input type="hidden" id="upic" name="pic" lay-verify="pic">
                <input type="hidden" id="ulastImg" name="lastImg">
                <input type="file" name="picfile" id='ui-file' accept=".jpg, .png" onchange="updsubmitFile()"
                       style="border-color: lightgray;background-color: lightgray;display: none">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label for="lang1" class="layui-form-label " style="width:100px">语种</label>
            <div class="layui-input-block">
                <input id="ulang" type="text" name="lang"
                       style="color: black; border-color: lightgray;background-color: white" lay-verify="lang"
                       autocomplete="off" placeholder="请输入语种" class="layui-input">
            </div>
        </div>
