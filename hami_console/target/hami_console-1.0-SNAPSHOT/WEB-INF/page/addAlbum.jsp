                        ...
                        <div class="widget-content">
                            <div class="body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label for="songer" class="control-label">歌手<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                    ...
                                    <div class="control-group">
                                        <label for="album" class="control-label">专辑<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                    ...
                                    <div class="control-group">
                                        <label for="mtype" class="control-label">流派<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                    ...
                                    <div class="control-group">
                                        <label for="isNew" class="control-label">是否新歌<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2">
                                    ...
                                    <div class="control-group">
                                        <label for="mtype" class="control-label">图片<span
                                                class="required">*</span></label>
                                        <div class="controls form-group">
                                            <div class="col-sm-4 col-md-2">
                                                <div class="image-row">
                                                    <div class="image-set"><a class="example-image-link"
                                                                              href="img/gallery-photo/image-3.jpg"
                                                                              data-lightbox="example-set"
                                                                              title="Click on the right side of the image to move forward.">
                                                        <img class="example-image" src="img/gallery-photo/thumb-3.jpg"
                                                             alt="Plants: image 1 0f 4 thumb" width="150" height="150"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        <label for="i-file" class="control-label">选择文件 <span
                                                class="required">*</span></label>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <textarea class="form-control" name="lyc" rows="3"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input type="file" name="mp3" id='i1-file' accept=".mp3, .wma"
                                               onchange="$('#mp3loc').val($('#i1-file').val());" style="display: none">
