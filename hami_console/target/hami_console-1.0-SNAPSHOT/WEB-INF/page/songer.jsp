...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#toUpd[update]").click(function () {
                var value = parseInt($(this).attr("value"));
                window.location.href = "/songer/toUpd?id=" + value;
            })
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：黄家驹" name="srname"
                                                       value="${mq.srname}" id="srname" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：香港" name="area" value="${mq.area}"
                                        ...
                                        <div class="controls form-group">
                                            <select id="tid" name="tid" class="form-control ">
                                                ...
                                                <c:forEach items="${mtypes}" var="m">
                                                    <option value="${m.tid}"
                                                            <c:if test="${m.tid == mq.tid}">selected</c:if>>${m.tname}</option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <table class="table table-striped table-images"
                                        ...
                                        <c:forEach items="${page.list}" var="songer">
                                            <tr>
                                                ...
                                                <td class="hidden-xs"><p><strong>${songer.isHot == 1?'热门':'一般'}</strong>
                                                </p></td>
                                                <td class="hidden-xs"> ${songer.mtype.tname} </td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" id="toUpd" update
                                                            value="${songer.srid}"> 修改
                                                    </button>
                                                    <button data-toggle="button" class="btn btn-sm btn-warning"
                                                            delete value="${songer.srid}"> 删除
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
